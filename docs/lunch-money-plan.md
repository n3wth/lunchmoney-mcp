# Lunch Money MCP execution plan
...
1. MCP client obtains an access token from [auth.n3wth.com](<http://auth.n3wth.com>) for this MCP resource. <issue id="697cea5d-d90d-44c3-91cb-b11a1ca62dec" href="https://linear.app/newth/issue/N-614/audit-authn3wthcom-oauth-and-mcp-compatibility">N-614</issue> verifies actual protocol, discovery, registration, PKCE, refresh/revocation and client compatibility.
...
4. An allowlisted typed adapter resolves the user's active connection and calls the pinned Lunch Money API. <issue id="1717fcb3-1830-44fd-8656-d8821e7ffe28" href="https://linear.app/newth/issue/N-625/configure-nango-lunch-money-bearer-token-connection">N-625</issue> selects Nango proxy versus transient server-side credential retrieval and verifies logging/egress implications.
...
| -- | -- |
| 1. Architecture and vertical slice | <issue id="697cea5d-d90d-44c3-91cb-b11a1ca62dec" href="https://linear.app/newth/issue/N-614/audit-authn3wthcom-oauth-and-mcp-compatibility">N-614</issue> → <issue id="877e654c-98ae-45fa-916e-ccc60b085a28" href="https://linear.app/newth/issue/N-611/define-identity-tenant-and-credential-data-model">N-611</issue> → <issue id="b06f2194-daa6-4d0a-91b4-be4d2f5fc2fd" href="https://linear.app/newth/issue/N-618/implement-authenticated-mcp-server-skeleton">N-618</issue>/<issue id="1717fcb3-1830-44fd-8656-d8821e7ffe28" href="https://linear.app/newth/issue/N-625/configure-nango-lunch-money-bearer-token-connection">N-625</issue>, alongside <issue id="d07cbf01-b5a8-4652-8129-f5d77b3dc842" href="https://linear.app/newth/issue/N-616/pin-lunch-money-v2-contract-and-implement-typed-adapter">N-616</issue> contract work; <issue id="17d927ff-6fa6-4c2c-8a4e-39725f6de5bc" href="https://linear.app/newth/issue/N-613/complete-end-to-end-lunch-money-vertical-slice">N-613</issue> proves two isolated staging users can read /me, accounts and transactions and disconnect safely. |
| 2. Read-only MCP implementation | <issue id="4d7b83ec-ce88-47b4-892b-c150fd9d0dc2" href="https://linear.app/newth/issue/N-620/design-and-implement-curated-read-only-tool-surface">N-620</issue> reads, <issue id="0514160e-f508-4a58-a931-d5a9584957ba" href="https://linear.app/newth/issue/N-615/implement-connection-status-and-revocation-ux">N-615</issue> lifecycle and <issue id="269c1b03-3c94-48c1-81e9-3a5925fbe23c" href="https://linear.app/newth/issue/N-612/add-privacy-safe-observability-and-rate-limiting">N-612</issue> operational controls pass. <issue id="4267be0f-d594-4499-9054-36e4ecc0553b" href="https://linear.app/newth/issue/N-619/threat-model-and-security-validation">N-619</issue> starts threat modeling during architecture and completes security validation on the candidate. |
| 3. Plugin packaging and external beta | <issue id="b971f198-a77e-4393-a3e4-8baeed9a2e7f" href="https://linear.app/newth/issue/N-623/build-and-validate-the-codex-plugin-package">N-623</issue> plugin and <issue id="d94faee7-827c-4b7f-82de-ae1d758c392a" href="https://linear.app/newth/issue/N-624/publish-user-and-operator-documentation">N-624</issue> docs precede <issue id="9655272f-83d4-4d7c-8915-7e98da6575fa" href="https://linear.app/newth/issue/N-617/deploy-production-service-and-run-external-beta">N-617</issue> release. Two users other than the developer complete setup/read/disconnect flows; no unresolved high/critical findings; rollback and failure recovery demonstrated. |
| 4. Post-beta mutations and safety | <issue id="4430d20d-b33e-48d5-abcc-266e127a6bdd" href="https://linear.app/newth/issue/N-622/add-scoped-write-tools-with-confirmation-controls">N-622</issue> begins after <issue id="9655272f-83d4-4d7c-8915-7e98da6575fa" href="https://linear.app/newth/issue/N-617/deploy-production-service-and-run-external-beta">N-617</issue> passes; trusted operation approval, scopes and duplicate/uncertain-outcome handling proven before enablement. <issue id="0adc622a-5b2f-4661-ab23-3d1c4c49e702" href="https://linear.app/newth/issue/N-621/add-destructive-tools-and-recovery-safeguards">N-621</issue> separately gates destructive operations. |
...
* <issue id="697cea5d-d90d-44c3-91cb-b11a1ca62dec" href="https://linear.app/newth/issue/N-614/audit-authn3wthcom-oauth-and-mcp-compatibility">N-614</issue>: auth source/deployment, actual token validation method, MCP/SDK/client versions, hosting/runtime and metadata storage. Preserve the existing auth service unless a documented incompatibility requires a decision.
* <issue id="d07cbf01-b5a8-4652-8129-f5d77b3dc842" href="https://linear.app/newth/issue/N-616/pin-lunch-money-v2-contract-and-implement-typed-adapter">N-616</issue>: exact OpenAPI version/source/checksum and deployed endpoint support. v2.11 compatibility is a target to verify; determine preview/stable status and derive operation count rather than assuming 59 live operations. Evaluate the official client before generating another.
* <issue id="1717fcb3-1830-44fd-8656-d8821e7ffe28" href="https://linear.app/newth/issue/N-625/configure-nango-lunch-money-bearer-token-connection">N-625</issue>: Nango bearer integration and plan support, secure completion verification, proxy versus retrieval, and effective upstream egress quota.
* <issue id="877e654c-98ae-45fa-916e-ccc60b085a28" href="https://linear.app/newth/issue/N-611/define-identity-tenant-and-credential-data-model">N-611</issue>/<issue id="0514160e-f508-4a58-a931-d5a9584957ba" href="https://linear.app/newth/issue/N-615/implement-connection-status-and-revocation-ux">N-615</issue>/<issue id="269c1b03-3c94-48c1-81e9-3a5925fbe23c" href="https://linear.app/newth/issue/N-612/add-privacy-safe-observability-and-rate-limiting">N-612</issue>: retention periods, backup expiry, revocation/in-flight behavior, deletion retry and measurable beta capacity.
* <issue id="4430d20d-b33e-48d5-abcc-266e127a6bdd" href="https://linear.app/newth/issue/N-622/add-scoped-write-tools-with-confirmation-controls">N-622</issue>: trusted human approval mechanism supported by the intended client or authenticated first-party UI. A model-supplied confirmation flag and tool annotations cannot enforce approval.
...
Initial bounded discovery: <issue id="697cea5d-d90d-44c3-91cb-b11a1ca62dec" href="https://linear.app/newth/issue/N-614/audit-authn3wthcom-oauth-and-mcp-compatibility">N-614</issue> public auth metadata/source references and <issue id="d07cbf01-b5a8-4652-8129-f5d77b3dc842" href="https://linear.app/newth/issue/N-616/pin-lunch-money-v2-contract-and-implement-typed-adapter">N-616</issue> pinned API/client contract. Implementation follows reviewed findings and repository/runtime selection; these issues are not complete merely because discovery was dispatched.
