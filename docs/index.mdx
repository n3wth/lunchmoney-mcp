...
<CardGroup cols={3}>
  <Card title="Connect" icon="plug" href="/connect">
    Add the server to your client, sign in, and link Lunch Money through a
    browser flow.
  </Card>
  <Card title="Tools" icon="wrench" href="/tools">
    The read-only tools your agent can call, and how pagination and currencies
    behave.
  </Card>
  <Card title="Privacy" icon="shield" href="/privacy">
    Where your data goes — token storage in Nango, transient reads, retention.
  </Card>
</CardGroup>
